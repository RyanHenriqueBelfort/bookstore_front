    ...
    <Tbody color="gray.300">
      {book.map((dados) => (
        <Tr key={dados.id}>
          ...
          <Td>{author.map((e) => (e.id == dados.author_id ? e.name : ""))}</Td>

          <Td>{gender.map((e) => (e.id == dados.gender_id ? e.name : ""))}</Td>

          <Td>
            {publisher.map((e) => (e.id == dados.publisher_id ? e.name : ""))}
          </Td>
          ...
          <Td>
            <Stack direction="row" spacing={5}>
              <ButtonTable
                ...
                onClick={() => router.push(`/edit/book/${dados.id}`)}
              >
                Editar
              </ButtonTable>
