...
export default function Index() {
  const { author, gender, publisher, setBook } = useContext(BookContext);
  ...
  const notifyError = () =>
    toast.error("Preencha os campos autor, editora e gênero", {
      draggable: true,
      closeOnClick: true,
    });
  ...
  const onSubmit = (data) => {
    if (
      (data.autores == "DEFAULT") |
      (data.editora == "DEFAULT") |
      (data.generos == "DEFAULT")
    ) {
      notifyError();
    } else {
      api.post("/book", {
